...
'''
postgresCreate='''
CREATE TABLE IF NOT EXISTS data (index INT, alt VARCHAR(5000), extra_parts VARCHAR(5000) , img VARCHAR(5000),num INT, safe_title VARCHAR(5000), title VARCHAR(5000), transcript VARCHAR(20000), PRIMARY KEY (num));'''
postgresClear='''
DROP TABLE data
'''
