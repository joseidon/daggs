...
'''
postgresCreate='''
CREATE TABLE IF NOT EXISTS data (index INT, num INT, safe_title VARCHAR(1000), transcript VARCHAR(1000), alt VARCHAR(1000), img VARCHAR(1000), title VARCHAR(1000), day VARCHAR(1000), PRIMARY KEY (num));
'''
